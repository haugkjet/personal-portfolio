      ...
      <ul className="m-0">
        <li>
          <PriceTracker
            ...
            lastUpdate={pricesToTrack[0].lastUpdate}
          ></PriceTracker>
        </li>
        <li>
          <PriceTracker
            ...
            lastUpdate={pricesToTrack[1].lastUpdate}
          ></PriceTracker>
        </li>
        <li>
          <PriceTracker
            ...
            lastUpdate={pricesToTrack[2].lastUpdate}
          ></PriceTracker>
        </li>
        <li>
          <PriceTracker
            ...
            lastUpdate={pricesToTrack[3].lastUpdate}
          ></PriceTracker>
        </li>
        <li>
          <PriceTracker
...
export default PriceTrackerList;
